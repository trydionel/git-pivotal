...
Gem::Specification.new do |s|
  ...
  s.executables = ["git-pivotinfo", "git-finish", "git-pick", "git-chore", "git-bug", "git-feature"]
  s.extra_rdoc_files = [
    "LICENSE"
  ]
  s.files = [
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<pivotal-tracker>, ["~> 0.2.2"])
      ...
      s.add_dependency(%q<pivotal-tracker>, ["~> 0.2.2"])
